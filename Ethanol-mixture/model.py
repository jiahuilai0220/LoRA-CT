...
class CNN(nn.Module):
    def __init__(self):
        ...
        self.Conv1d_1=nn.Conv1d(in_channels=1, out_channels=16, kernel_size=5, stride=3)
        self.BatchNorm1d_1=nn.BatchNorm1d(16)
        self.RELU_1=nn.LeakyReLU()
        self.Conv1d_2=nn.Conv1d(in_channels=16, out_channels=32, kernel_size=5, stride=2)
        self.BatchNorm1d_2=nn.BatchNorm1d(32)
        self.RELU_2=nn.LeakyReLU()
        self.Conv1d_3=nn.Conv1d(in_channels=32, out_channels=64, kernel_size=5, stride=2)
        self.BatchNorm1d_3=nn.BatchNorm1d(64)
        self.RELU_3=nn.LeakyReLU()
        self.AdaptiveMaxPool1d=nn.AdaptiveMaxPool1d(120) #参数表示输出的特征维度
        self.Flatten=nn.Flatten()
        self.Linear=nn.Linear(64*120,32*120)
        self.Linear2=nn.Linear(32*120,1)
