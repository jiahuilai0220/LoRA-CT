...
class CNN(nn.Module):
    def __init__(self):
        ...
        self.Conv1d_1=nn.Conv1d(in_channels=1, out_channels=16, kernel_size=3, stride=2)
        ...
        self.Conv1d_3=nn.Conv1d(in_channels=32, out_channels=64, kernel_size=1, stride=3)
